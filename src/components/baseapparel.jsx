...
const BaseApparel = () => {
  return (
    <div className="flex justify-center items-center m-auto h-screen w-full">
      <div className="  bg-[url('/bg-base-apparel.svg')] h-[600px] w-[830px]">
        <div className="flex justify-start items-start flex-col p-10 ml-20">
          <svg
          ...
          <div className="my-6 text-start">
            <h1 className="font-sans font-light text-6xl text-[#f96262]">
              WE'RE
            </h1>
            <span className="font-medium text-6xl text-[#000]">
              COMING <br />
              SOON
            </span>
              ...
              <fieldset>
                <label htmlFor="email">
                  <input
                    ...
                    className="text-sm p-2 rounded-xl border-2 border-solid border-[#d0c7c7]"
                  />
                </label>
                <button className="absolute bg-[#f96262] text-secondary hove:backdrop-filter backdrop-blur-lg bg-opacity-30 z-10 p-3 w-16 rounded-2xl">
